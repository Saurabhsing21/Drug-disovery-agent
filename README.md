...
| **LLM Models** | OpenAI GPT models | Reasoning-heavy synthesis, Automated model fallbacks |
...
*   **OpenAI Runtime**: Live report generation and agent reasoning use OpenAI models with same-provider fallbacks.
