# Agent I/O + Prompts (Run: `egfr-agent-io-trace-01`)
...
```json
{
  "input_validation_report": {
    ...
    "summary": "Validated request for EGFR; found 43 episodic memory match(es)."
  },
  "past_runs": [
    {
      "conflict_count": 0,
    ...
    },
    {
      ...
      "gene_symbol": "EGFR",
      "review_decision": null,
      "run_id": "run-12fe97cdd1b6",
      "summary_excerpt": "# Target Evidence Summary: EGFR"
    },
    {
      "conflict_count": 0,
      "disease_id": null,
      "dossier_artifact_path": "/Users/apple/Desktop/Drugagent/artifacts/dossiers/run-15b786b2f5d4.evidence_dossier.json",
      "evidence_count": 0,
      "gene_symbol": "EGFR",
      "review_decision": null,
      "run_id": "run-15b786b2f5d4",
      "summary_excerpt": "# Target Evidence Summary: EGFR"
    },
    {
      "conflict_count": 0,
      "disease_id": null,
      "dossier_artifact_path": "/Users/apple/Desktop/Drugagent/artifacts/dossiers/run-21db4a3db3ec.evidence_dossier.json",
      "evidence_count": 0,
      "gene_symbol": "EGFR",
      "review_decision": null,
      "run_id": "run-21db4a3db3ec",
      "summary_excerpt": "# Target Evi
... [TRUNCATED]
...
{
  "plan": {
    "artifact_path": "/Users/apple/Desktop/Drugagent/artifacts/plans/egfr-agent-io-trace-01.collection_plan.json",
    "created_at": "2026-03-13T09:25:34.765791Z",
    "execution_notes": [
      "Found 22 prior episodic match(es) for this query.",
      "Latest related run `run-ef549f520060` has no recorded review decision."
    ],
    "expected_outputs": {
      "depmap": [
        "evidence_records",
    ...
    "query_intent": "Collect Phase-1 evidence for target EGFR. Memory-informed planning enabled from 22 prior run(s).",
    "query_variants": [
      "EGFR",
      "ERBB1"
    ],
  ...
  "planning_report": {
    ...
    "generation_mode": "cached_planner",
    "model_used": null,
    "next_actions": [
    ...
    "summary": "Collect Phase-1 evidence for target EGFR. Memory-informed planning enabled from 22 prior run(s)."
  }
}
```
  ...
  "evidence_items": [
    {
      ...
      "provenance": {
        ...
        "retrieved_at": "2026-03-13T09:25:52.229912Z"
      },
      "raw_value": -0.24344198617953822,
      "retrieved_at": "2026-03-13T09:25:52.231535Z",
      "source": "depmap",
    ...
    },
    {
      ...
      "provenance": {
        ...
        "retrieved_at": "2026-03-13T09:25:52.240761Z"
      },
      "raw_value": -2.8485944935115963,
      "retrieved_at": "2026-03-13T09:25:52.240810Z",
      "source": "depmap",
    ...
    },
    {
      ...
      "provenance": {
        ...
        "retrieved_at": "2026-03-13T09:25:52.240834Z"
      },
      "raw_value": -2.1649094219761693,
      "retrieved_at": "2026-03-13T09:25:52.240842Z",
      "source": "depmap",
    ...
    },
    {
      ...
      "provenance": {
        ...
        "retrieved_at": "2026-03-13T09:25:52.240852Z"
      },
      "raw_value": -2.0740745545977006,
      "retrieved_at": "2026-03-13T09:25:52.240857Z",
      "source": "depmap",
    ...
    },
    {
      ...
      "provenance": {
        ...
        "retrieved_at": "2026-03-13T09:25:52.240864Z"
      },
      "raw_value": -2.0341014472599146,
      "retrieved_at": "2026-03-13T09:25:52.240869Z",
      "source": "depmap",
    ...
    },
    {
      ...
      "provenance": {
        ...
        "retrieved_at": "2026-03-13T09:25:52.240876Z"
      },
      "raw_value": -2.032630840040893,
      "retrieved_at": "2026-03-13T09:25:52.240881Z",
      "source": "depma
... [TRUNCATED]
...
```json
{
  ...
  "verification_report": {
    ...
    "blocking_issues": [],
    "fail_count": 0,
    "generated_at": "2026-03-13T09:25:52.716202Z",
    "pass_count": 7,
    "rule_outcomes": [
      {
        "blocking": true,
...
{
  "evidence_graph": {
    "artifact_path": "/Users/apple/Desktop/Drugagent/artifacts/graphs/egfr-agent-io-trace-01.evidence_graph.json",
    "edges": [
      {
        "attributes": {},
...
- system: `/Users/apple/Desktop/Drugagent/artifacts/prompts/egfr-agent-io-trace-01/summary_agent.generate_explanation.system.txt`
- user: `/Users/apple/Desktop/Drugagent/artifacts/prompts/egfr-agent-io-trace-01/summary_agent.generate_explanation.user.txt`
...
```json
{
  ...
  "supervisor_decision": {
    ...
    "rationale": "Evidence collection, normalization, and explanation were successful with no blocking issues, warnings, or conflicts detected. The workflow can proceed to emit the dossier."
  }
}
```
...
- user: `/Users/apple/Desktop/Drugagent/artifacts/prompts/egfr-agent-io-trace-01/supervisor_agent.supervisor_decide.user.txt`
...
Warning issues: []
Conflict count: 0
Source status: [{'source': 'depmap', 'status': 'success', 'duration_ms': 16168, 'record_count': 15, 'error_code': None, 'error_message': None}, {'source': 'literature', 'status': 'success', 'duration_ms': 1604, 'record_count': 15, 'error_code': None, 'error_message': None}]
Agent reports: [{'agent_name': 'input_validation_agent', 'stage_name': 'validate_input', 'summary': 'Validated request for EGFR; found 43 episodic memory match(es).', 'decisions': ['Confirmed request contract shape.', 'Prepared query for planning stage.'], 'risks': [], 'next_actions': ['Send request and memory context into planning agent.'], 'structured_payload': {'run_id': 'egfr-agent-io-trace-01', 'gene_symbol': 'EGFR', 'disease_id': None, 'past_run_count': 43}, 'generation_mode': 'deterministic_fallback', 'model_used': None}, {'agent_name': 'planning_agent', 'stage_name': 'plan_collection', 'summary': 'Collect Phase-1 evidence for target EGFR. Memory-informed planning enabled from 22 prior run(s).', 'decisions': ['Selected sources: depmap, literature', 'Prepared per-source directives for collection agents.'], 'risks': [], 'next_actions': ['Execute planned source collection in planner-defined order.'], 'structured_payload': {'run_id': 'egfr-agent-io-trace-01', 'selected_sources': ['depmap', 'literature'], 'query_intent': 'Collect Phase-1 evidence for target EGFR. Memory-informed planning enabled from 22 prior run(s).', 'query_variants': ['EGFR', 'ERBB1'], 'memory_context': {'match_count': 43, 'latest_run_id': 'sanity-no-llm', 'latest_review_decision': None, 'latest_evidence_count': 30, 'recent_run_ids': ['sanity-google-llm', 'sanity-lean', 'sanity-no-llm']}, 'execution_notes': ['Found 22 prior episodic match(es) for this query.', 'Latest related run `run-ef549f520060` has no recorded review decision.'], 'source_directives': {'depmap': 'Collect 15 evidence records for EGFR.', 'literature': 'Collect 15 evidence records for EGFR.'}, 'retry_policy': {'max_attempts': 3, 'base_delay_ms': 100, 'max_delay_ms': 400, 'strategy': 'bounded_exponential_backoff', 'fallback': 'emit_partial_result', 'retryable_error_codes': ['timeout', 'rate_limit', 'upstream_error']}, 'expected_outputs': {'depmap': ['evidence_records', 'source_status'], 'literature': ['evidence_records', 'source_status']}, 'artifact_path': '/Users/apple/Desktop/Drugagent/artifacts/plans/egfr-agent-io-trace-01.collection_plan.json', 'plan_version': 'phase1.v1', 'planning_mode': 'cached_planner', 'planner_model_used': None, 'created_at': '2026-03-13T09:25:34.765791Z'}, 'generation_mode': 'cached_planner', 'model_used': None}, {'agent_name': 'normalization_agent', 'stage_name': 'normalize_evidence', 'summary': 'Normalized 30 of 30 raw evidence record(s) into canonical schema.', 'decisions': ['Standardized target symbols to uppercase canonical form.', 'Clamped normalized scores and confidence into [0,1].', 'Attached normalization policy version to each normalized record.'], 'risks': [], 'next_actions': ['Pass normalized evidence into verification agent.'], 'structured_payload': {'raw_count': 30, 'normalized_count': 30}, 'generation_mode': 'deterministic_fallback', 'model_used': None}, {'agent_name': 'summary_agent', 'stage_name': 'generate_explanation', 'summary': 'Generated evidence summary for EGFR.', 'decisions': ['Synthesized grounded findings from verified evidence only.'], 'risks': [], 'next_actions': ['Provide summary context to supervisor and review-support agents.'], 'structured_payload': {'generation_mode': 'deterministic_fallback', 'model_used': None}, 'generation_mode': 'deterministic_fallback', 'model_used': None}]
...
```json
{
  ...
  "final_dossier": {
    "artifact_path": "/Users/apple/Desktop/Drugagent/artifacts/dossiers/egfr-agent-io-trace-01.evidence_dossier.json",
    "artifacts": {
      "graph": "/Users/apple/Desktop/Drugagent/artifacts/graphs/egfr-agent-io-trace-01.evidence_graph.json",
      "plan": "/Users/apple/Desktop/Drugagent/artifacts/plans/egfr-agent-io-trace-01.collection_plan.json"
    },
    "conflicts": [],
    "emitted_at": "2026-03-13T09:27:05.647647Z",
    "errors": [],
    "graph_snapshot": {
      "artifact_path": "/Users/apple/Desktop/Drugagent/artifacts/graphs/egfr-agent-io-trace-01.evidence_graph.json",
      "edges": [
